#!/bin/sh
#
# CannyOS cannyos-application-archlinux-gtk3-gimp container build script
#
# https://github.com/intlabs/cannyos-application-archlinux-gtk3-gimp
#
...
#
clear
curl https://raw.githubusercontent.com/intlabs/cannyos-application-archlinux-gtk3-gimp/master/CannyOS/CannyOS.splash
#     *****************************************************
#     *                                                   *
#     *        _____                    ____  ____        *
...
sudo mkdir -p "/CannyOS/build/cannyos-application-archlinux-gtk3-gimp"
# Ensure that there it is clear
sudo rm -r -f "/CannyOS/build/cannyos-application-archlinux-gtk3-gimp/*"
...
sudo docker run -i -t -d \
 ...
 --user "root" \
 -p 80 \
 intlabs/cannyos-application-archlinux-gtk3-gimp 
